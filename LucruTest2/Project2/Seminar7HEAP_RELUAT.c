...
//
//	if (pozFiuSt < heap.nrMasini && heap.masini[pozMax].id < heap.masini[pozFiuSt].id) {
//		pozMax = pozFiuSt;
//	}
//	if (pozFiuDr < heap.nrMasini && heap.masini[pozMax].id < heap.masini[pozFiuDr].id) {
//		pozMax = pozFiuDr;
//	}
//
...
//	//afiseaza DOAR elementele ascunse din heap
...
//
//		//deep copy daca vrem sa stergem elementul extras
//	}
//
//}
//
